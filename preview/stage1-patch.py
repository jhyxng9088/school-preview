...
if len(sys.argv) != 3:
    raise SystemExit('usage: stage1-patch.py <production-source> <main-sha>')
...
# Preview runtime isolation. Keep storage, Firebase identity and service-worker caches
# completely separate from production without changing production source ownership.
